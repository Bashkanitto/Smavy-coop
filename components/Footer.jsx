    ...
    <footer className="container mx-auto min-h-10">
      <nav className="flex flex-col sm:flex-row gap-5 justify-between items-center px-4 py-2">
        ...
        <ul className="flex gap-4 text-black text-xs">
          <button className="white-btn p-2 border rounded-lg">Instagram</button>
          <button className="white-btn p-2 border rounded-lg">Facebook</button>
          <button className="white-btn p-2 border rounded-lg">Twitter</button>
        </ul>
      </nav>
    </footer>
  );
